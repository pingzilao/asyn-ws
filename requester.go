...
func (this *DefaultRequester) IsSimpleReq() bool {
	return this.Sub == EVENT_nonesub
}

func (this *DefaultRequester) IsSub() bool {
	return this.Sub == EVENT_sub
}

func (this *DefaultRequester) IsUnSub() bool {
	return this.Sub == EVENT_unsub || strings.HasSuffix(this.Url.Path, "cancel")
}

func (this *DefaultRequester) CancelSub() {
	this.Sub = EVENT_unsub
	this.Values.Set("sub", EVENT_unsub)
...
func (this *DefaultRequester) SubErrClear(errCode int32) {
	if this.IsSub() && errCode != ErrCode_Success && this.clearHander != nil {
